...
class EUtente
{
    ...
    public function __construct(String $Nome, String $Cognome, String $NomeUtente, String $Email, String $Telefono, ELuogo $LuogoNascita, String $DataNascita, String $Password)
    {
        ...
        $this->DataNascita = DateTime::createFromFormat('d-m-Y', $DataNascita);
    ...
    {
        try {
            return new DateTime ($this->DataNascita->format('d-m-Y'));
        } catch (Exception $e) {
            echo $e->getMessage();
            return null;
        }
    ...
    {
        try {
            return new DateTime ($this->DataUltimoOrdine->format('d-m-Y'));
        } catch (Exception $e) {
            echo $e->getMessage();
            return null;
        }
